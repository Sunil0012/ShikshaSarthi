    ...
    <div className="mx-auto max-w-7xl px-6 py-16">
      <div className="max-w-3xl">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <Link to="/school-admin" className="inline-flex h-10 items-center rounded-full ring-1 ring-black/[0.1] px-5 text-sm font-medium hover:bg-zinc-50">Preview admin console</Link>
        </div>
      </div>

      ...
      <div className="grid items-end gap-10 md:grid-cols-2">
        <div>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <Link to="/teacher" className="inline-flex h-10 items-center rounded-full ring-1 ring-black/[0.1] px-5 text-sm font-medium hover:bg-zinc-50">Preview teacher dashboard</Link>
          </div>
        </div>
